...
angular.module('portfolioApp').directive('scrollContainer', scrollContainer);
...
angular.module('portfolioApp').directive("scrollHide", ["$window", function ($window) {
...
angular.module('portfolioApp').service('aboutService', function () {
    ...
    this.pulseNeon = function () {
        var workingNeon = document.querySelectorAll('.neon-animation');
        var flickeringNeon = document.querySelector('#neon-flicker');
...
// INITILIZE CONTROLLER
// ============================================================
angular.module("portfolioApp").controller("homeCtrl", ["$scope", "$rootScope", "reusableFuncsService", function ($scope, $rootScope, reusableFuncsService) {}]);
"use strict";
